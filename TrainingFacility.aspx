...
o	This setup is configured with industrial grade automation devices.  Students get to know about the operating principles, the physics, the applications, installation and tuning procedures of various sensing devices such as Inductive sensors, Capacitive sensors, Photoelectric sensors ( with Direct detection, ER, Retro-reflective, Background Suppression options), Magnetic sensors, Ultrasonic sensors , Color Contrast sensors, Distance Measurement and Positioning sensors, Incremental Rotary Encoder, Speed / Frequency indicators, etc
         ...
         <div>
            <h3>•	Control & Visualization technology learning station </h3>
            <p>o	The setup is configured around Siemens industrial grade automation devices. Students get to know about the operating principles of machine and process automation, digital and analog signal interfacing, data / message handling and execution of a variety of open loop and closed loop control functions.  Students get to work using conventional I/O simulators, moving towards usage and programming of smart, interactive display stations, configuring peer to peer and master-slave industrial networks. Programmable Controllers and  a interactive touch screen based HMI helps students to simualte industry relevant case studies
        </div>
